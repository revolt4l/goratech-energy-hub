      ...
      <div className="container mx-auto px-4">
        ...
        {testimonials.length > 0 && (
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            {testimonials.map((t) => (
              <div key={t.id} className="rounded-xl border border-border bg-card p-8 glow-box flex flex-col">
        ...
        {/* Submission form */}
        <div className="max-w-lg mx-auto rounded-xl border border-border bg-card p-8 glow-box">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
                ...
                >
                  <Star
                    className={`h-5 w-5 transition-colors ${
                      r <= rating ? "fill-primary text-primary" : "text-muted-foreground/30"
                    }`}
                  />
                </button>
              ))}
            ...
            <Textarea
              placeholder="Tell us about your experience with GORATECH..."
              value={message}
